...
export default function ReverseMortgagePage() {
  ...
  const faqs = [
    {
      q: "Who qualifies for a Reverse Mortgage (HECM) in Arizona?",
      a: "Homeowners age 62 or older who have substantial equity in their primary residence qualify for a Home Equity Conversion Mortgage (HECM)."
    },
    {
      q: "Do I retain ownership of my home with a Reverse Mortgage?",
      a: "Yes! You retain full title and ownership of your home. You are only required to maintain property taxes, homeowners insurance, and home upkeep."
    },
    {
      q: "When does a Reverse Mortgage need to be repaid?",
      a: "The loan becomes due when the last surviving borrower permanently moves out, sells the home, or passes away."
    }
  ];
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-[#c8c8b8] text-[16px] lg:text-[18px] leading-relaxed max-w-2xl">
                Convert a portion of your home equity into tax-free cash or eliminate monthly mortgage payments for Arizona seniors age 62+.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-3xl border border-white/15 bg-[#0a2e1d] p-6 text-left">
                <h3 className="text-[22px] font-bold text-white mb-3 font-playfair">Reverse Mortgage Benefits</h3>
                <ul className="space-y-3 text-[14.5px] text-[#c8c8b8]">
                  <li>✓ Eliminate monthly principal &amp; interest payments</li>
                  <li>✓ Receive tax-free monthly income or line of credit</li>
                  <li>✓ Retain home ownership &amp; title</li>
        ...
        <section className="py-16 lg:py-20 px-6 lg:px-12 bg-white text-left max-w-4xl mx-auto space-y-6">
          <h2 className="text-[#052316] text-[28px] lg:text-[38px] font-bold font-playfair">
            Unlock Financial Peace of Mind in Retirement
          </h2>
          <p className="text-[#4e5b4e] text-[15.5px] leading-relaxed">
            A Reverse Mortgage (HECM) allows senior homeowners in Arizona to leverage their home equity to supplement retirement income, cover healthcare costs, or enjoy tax-free cash flow without selling their home.
          </p>
        </section>

        <section className="py-16 lg:py-20 px-6 lg:px-12 bg-[#fcf9f3]">
          <div className="max-w-4xl mx-auto space-y-8">
            <h2 className="text-[#052316] text-[28px] font-bold font-playfair text-center">Reverse Mortgage FAQ</h2>
        ...
        <section className="py-16 bg-[#052316] text-white text-center">
          <h2 className="text-[28px] font-bold font-playfair mb-4">Speak with an Arizona Reverse Mortgage Specialist</h2>

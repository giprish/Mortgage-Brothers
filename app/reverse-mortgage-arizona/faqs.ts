...
export const faqs = [
  ...
  { q: "How are the funds from a reverse mortgage disbursed?", a: "After paying off any existing mortgages or liens, you can receive the remaining funds in several ways: lump sum, line of credit, or monthly draws. You can choose the option that best fits your financial needs." },
  { q: "What documents do I need for a reverse mortgage application?", a: "When applying, you'll need to bring: HUD counseling certificate, driver's license or ID, proof of Social Security number, current mortgage statement (if applicable), homeowners insurance declaration page, and HOA statement (if applicable)." },

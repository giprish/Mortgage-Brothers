...
const quickAnswers = [
  ...
  },
  {
    ...
    a: "Compare the cash offer's net price, closing speed, repair requirements, fees or commissions, and the buyer's credibility against your other options: a traditional sale, an as-is agent sale, or keeping and refinancing the home. Mortgage Brothers LLC — which does not buy houses — provides an unbiased, free comparison so you can decide with confidence.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Cash for houses in Arizona typically comes from real estate investors, \"We Buy Houses\" companies, and iBuyers. They buy quickly and often as-is, but usually pay below full market value in exchange for speed and convenience. Mortgage Brothers LLC does not buy houses — as independent mortgage experts, we help you compare those cash offers against your other options at no cost.",
  },
  {
      ...
      <main className="flex-grow">
        ...
        <section className="loan-section bg-[#052316] text-white">
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <p className="text-[#c8c8b8] text-[15px] leading-relaxed">
              These are exactly the kinds of details a neutral expert can help you read. Because Mortgage Brothers LLC doesn&apos;t buy homes, we can look at any cash offer for your house alongside you and explain — in plain numbers — how it compares to selling on the open market, selling as-is, or holding the property.
            </p>
          </div>
        </section>

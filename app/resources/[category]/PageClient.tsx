              ...
              <div className="flex flex-col gap-6">
                {filteredArticles.map((art) => {
                  ...
                  return (
                    ...
                    {/* Right arrow icon */}
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#fcf9f3] flex items-center justify-center text-[#3fb364] group-hover:bg-[#3fb364] group-hover:text-[#ffffff] group-hover:[&_svg]:stroke-[#ffffff] group-hover:[&_svg]:text-[#ffffff] transition-colors duration-200">

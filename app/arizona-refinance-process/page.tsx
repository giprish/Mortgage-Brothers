...
const articleFaqs = [
  ...
  { question: "Will I automatically qualify for a refinance?", answer: "No. You will have to qualify for a refinance, however certain programs will allow for a reduced quantity of documentation such as the FHA and FHA Streamline. ← Previous PostNext Post → [](tel:+16025352171) Categories Arizona Mortgage Insights FHA Loans Homeownership Tips Mortgage Basics Mortgage Payments & Strategies Mortgage Process Guidance Mortgage Qualifications Real Estate & Mortgages Specialty Loans Spouse & Estate Considerations" },
] as const;

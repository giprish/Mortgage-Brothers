...
const articleFaqs = [
  ...
  { question: "I’ve heard that you should only refinance if there is at least a 1% drop in my mortgage rate. Is this true?", answer: "The answer is…every mortgage is different. Sometimes 1/2% could be beneficial, sometimes 1% may not be!" },
  { question: "Couldn’t I simply compare my current payment to the proposed payment and figure out my benefit?", answer: "This is an easy way to look at your “cash flow” savings, but depending on your amortization schedule, the overall cost savings can be very different. Over the life of the mortgage loan you may or may not save money, but it might benefit your current cash flow." },
  { question: "Is it easier to refinance with my current mortgage company?", answer: "Sometimes your current Arizona mortgage lender can help to reduce documentation that’s required, but they make up for that with other costs. Make sure that you check to assure the best deal." },
  { question: "Will I automatically qualify for a refinance?", answer: "No. You will have to qualify for a refinance, however certain programs will allow for a reduced quantity of documentation such as the FHA and FHA Streamline." },

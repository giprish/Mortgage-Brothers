...
export default function MortgageAffordabilityCalculator() {
  ...
  // Advanced States (Taxes, Insurance, PMI)
  ...
  // Results State — null means not yet calculated
  ...
  const solveScenario = useCallback(
    (
      ...
      return {
        ...
        monthlyPI,
        propertyTax,
        homeownersInsurance: monthlyIns,
        monthlyPMI,
        totalHousingPayment: totalHousing,
        existingDebts: extDebts,
        totalMonthlyDebt: totalDebt,
        resultingDTI,
        targetDTI: targetDtiRatio * 100,
        downPaymentPct: dpPctFinal,
      };
    },
    []
  );
      ...
      <main className="flex-grow">
        ...
        <section className="py-12 px-6 lg:px-10 max-w-5xl mx-auto">
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-3xl border border-[#e8e0d0]/60 p-6 lg:p-8 shadow-sm flex flex-col gap-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex bg-[#fcf9f3] border border-[#e8e0d0] rounded-lg p-0.5 text-[12px] font-semibold">
                    <button
                      onClick={() => setIncomePeriod("monthly")}
                      className={`px-3 py-1 rounded-md transition-all cursor-pointer ${incomePeriod === "monthly" ? "bg-[#052316] text-white shadow-sm" : "text-[#4e5b4e]"}`}
                    >Monthly</button>
                    <button
                      onClick={() => setIncomePeriod("annual")}
                      className={`px-3 py-1 rounded-md transition-all cursor-pointer ${incomePeriod === "annual" ? "bg-[#052316] text-white shadow-sm" : "text-[#4e5b4e]"}`}
                    >Annual</button>
                  </div>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[#a89a70] text-[11px] font-medium uppercase tracking-wider">Auto, Credit Cards, Student Loans</span>
                </div>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#888] text-[15px] font-semibold">$</span>
            ...
            {/* Card 2: Escrow & PMI Assumptions */}
            <div className="bg-white rounded-3xl border border-[#e8e0d0]/60 p-6 lg:p-8 shadow-sm flex flex-col gap-6">
              <h3 className="text-[#052316] text-[18px] font-bold pb-3 border-b border-[#e8e0d0]/40">
                2. Escrow & PMI Assumptions
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative flex-grow">
                    ...
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[#888] text-[14px]">
        ...
        {showResults && results && primaryResult && (
          <section id="affordability-results" className="pb-16 px-6 lg:px-10 max-w-7xl mx-auto animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              {/* LEFT COLUMN: Comparison & Scenarios */}
              <div className="lg:col-span-7 flex flex-col gap-6">

                {/* Scenario Comparison Visual */}
                <div className="bg-white rounded-3xl border border-[#e8e0d0]/60 p-6 lg:p-8 shadow-sm">
                  <h3 className="text-[#052316] text-[18px] font-bold mb-6 pb-3 border-b border-[#e8e0d0]/40">
                    Affordability Scenarios Comparison
                  </h3>
                  <div className="flex flex-col gap-6">
                    {/* Conservative */}
                    <div>
                      ...
                      <div className="w-full h-3.5 rounded-full bg-[#fcf9f3] border border-[#e8e0d0]/40 overflow-hidden">
                        <div className="h-full bg-yellow-500 rounded-full transition-all duration-700 ease-out"
                          style={{ width: `${barPercent(results.conservative.homePrice, maxScenarioHomePrice)}%` }}></div>
                      </div>
                    </div>
                    {/* Moderate */}
                    <div>
                      ...
                      <div className="w-full h-3.5 rounded-full bg-[#fcf9f3] border border-[#e8e0d0]/40 overflow-hidden">
                        <div className="h-full bg-blue-500 rounded-full transition-all duration-700 ease-out"
                          style={{ width: `${barPercent(results.moderate.homePrice, maxScenarioHomePrice)}%` }}></div>
                      </div>
                    </div>
                    {/* Aggressive */}
                    <div>
                      ...
                      <div className="w-full h-3.5 rounded-full bg-[#fcf9f3] border border-[#e8e0d0]/40 overflow-hidden">
                        <div className="h-full bg-[#3fb364] rounded-full transition-all duration-700 ease-out"
                          style={{ width: `${barPercent(results.aggressive.homePrice, maxScenarioHomePrice)}%` }}></div>
                      </div>
                    </div>
                  </div>
                </div>

                {/* Understanding DTI Cards */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white p-5 rounded-2xl border border-[#e8e0d0]/40 shadow-sm">
                    ...
                    <h4 className="text-[#052316] text-[14px] font-bold mb-1.5">Conservative</h4>
                    <p className="text-[12.5px] text-[#888] leading-relaxed">
                      Safest budget limit. Provides maximum protection against income changes and unexpected expenses.
                    </p>
                  </div>
                  <div className="bg-white p-5 rounded-2xl border border-[#e8e0d0]/40 shadow-sm">
                    ...
                    <h4 className="text-[#052316] text-[14px] font-bold mb-1.5">Moderate</h4>
                    <p className="text-[12.5px] text-[#888] leading-relaxed">
                      Standard boundary for most conventional lenders. Balanced approach between comfort and purchasing power.
                    </p>
                  </div>
                  <div className="bg-white p-5 rounded-2xl border border-[#e8e0d0]/40 shadow-sm">
                    ...
                    <h4 className="text-[#052316] text-[14px] font-bold mb-1.5">Aggressive</h4>
                    <p className="text-[12.5px] text-[#888] leading-relaxed">
                      Upper threshold allowed by automated underwriting systems like Fannie Mae&apos;s Desktop Underwriter.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-[#052316] rounded-3xl p-6 lg:p-8 text-white relative overflow-hidden shadow-md">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-[#c8c8b8] text-[13.5px] leading-relaxed mb-5">
                      Skip the estimates. Get a fully underwritten pre-approval from the Knoell team &mdash; typically closed in just 24 days.
                    </p>
                    <Link href="/#get-pre-approved"
                      className="bg-[#3fb364] hover:bg-[#349b55] text-white text-[14px] font-bold px-6 py-3 rounded-full inline-flex items-center gap-2 transition-all shadow-md">
                      Start Pre-Approval
              ...
              {/* RIGHT COLUMN: Primary Result Detail */}
              <div className="lg:col-span-5 flex flex-col gap-6">

                {/* Tab Selector */}
                <div className="bg-white border border-[#e8e0d0]/60 rounded-2xl p-1.5 flex gap-1 shadow-sm">
                  <button onClick={() => setSelectedDtiTab("conservative")}
                    className={`flex-1 py-3 text-[13px] font-bold rounded-xl transition-all cursor-pointer ${selectedDtiTab === "conservative" ? "bg-yellow-500 text-white shadow-sm" : "text-[#4e5b4e] hover:bg-[#fcf9f3]"}`}>
                    30% DTI
                  </button>
                  <button onClick={() => setSelectedDtiTab("moderate")}
                    className={`flex-1 py-3 text-[13px] font-bold rounded-xl transition-all cursor-pointer ${selectedDtiTab === "moderate" ? "bg-blue-500 text-white shadow-sm" : "text-[#4e5b4e] hover:bg-[#fcf9f3]"}`}>
                    40% DTI
                  </button>
                  <button onClick={() => setSelectedDtiTab("aggressive")}
                    className={`flex-1 py-3 text-[13px] font-bold rounded-xl transition-all cursor-pointer ${selectedDtiTab === "aggressive" ? "bg-[#3fb364] text-white shadow-sm" : "text-[#4e5b4e] hover:bg-[#fcf9f3]"}`}>
                    48% DTI
                  </button>
                </div>

                {/* Main Results Card */}
                <div className="bg-[#faf7f0] border border-[#e8e0d0]/60 rounded-3xl p-6 lg:p-8 shadow-md flex flex-col">
                  <span className="text-[#a89a70] text-[10px] font-bold tracking-[0.2em] uppercase mb-2 block">
                    MAXIMUM AFFORDABLE HOME PRICE
                  </span>
                  <h2 className="text-[#052316] text-[40px] lg:text-[48px] font-bold leading-none tracking-tight mb-6">
                    {formatCurrency(primaryResult.homePrice)}
                  </h2>
                  ...
                  {/* Monthly Breakdown */}
                  <span className="text-[#a89a70] text-[10px] font-bold tracking-[0.2em] uppercase mb-3 block">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-between text-[13px] text-[#b89a5a] italic mt-1">
                      <span>Target DTI limit</span>
                      <span>{primaryResult.targetDTI}%</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {!showResults && (
          <section className="pb-16 px-6 lg:px-10 max-w-3xl mx-auto text-center">
            <div className="bg-white rounded-3xl border border-[#e8e0d0]/60 p-10 lg:p-14 shadow-sm">
              ...
              <p className="text-[#888] text-[14.5px] leading-relaxed max-w-md mx-auto">
                Fill in your financial information, then click <strong>&ldquo;Calculate My Affordability&rdquo;</strong> to see your maximum home price under three different DTI scenarios.
              </p>
            </div>
          </section>
        )}

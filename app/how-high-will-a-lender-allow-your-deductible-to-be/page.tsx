      ...
      <main className="flex-grow relative z-0">
        <section className="relative z-0 w-full bg-white overflow-hidden">
          <div className="w-[90%] max-w-[1520px] mx-auto px-0 py-3 lg:py-5">
            ...
            <img
              src="/home/how-high-will-a-lender-allow-your-deductible-to-be.jpg"
              alt="Exploring lender deductible limits and their effect on mortgage insurance requirements."
              width={1920}
              height={1080}

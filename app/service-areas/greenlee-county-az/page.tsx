  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow pt-[64px] sm:pt-[72px]">
        ...
        <CTA
          eyebrow=""
          title="Ready to Start Your Home Mortgage Journey in Greenlee County?"
          description="Our Greenlee County mortgage experts are here to guide you through every step of the home loan process. From Clifton to Duncan and surrounding communities, we help buyers and homeowners secure the right mortgage solutions with confidence."
          primaryLabel="View All Greenlee County Areas"
          primaryHref="#areas"

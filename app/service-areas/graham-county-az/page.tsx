      ...
      <main className="flex-grow pt-[64px] sm:pt-[72px]">
        <section className="w-full bg-brand-green-deep text-white py-16 lg:py-20 text-center relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col items-center">
            ...
            <p className="text-brand-text-light text-[15px] lg:text-[17px] leading-[1.7] max-w-2xl mx-auto mb-8">Mortgage Brothers provides reliable mortgage solutions for homebuyers and homeowners throughout Graham County, Arizona.</p>
        ...
        <CTA
          eyebrow=""
          title="Ready to Start Your Home Mortgage Journey in Graham County?"
          description="Our Graham County mortgage experts are here to guide you through every step of the home loan process. From Safford to Thatcher and surrounding communities, we help buyers and homeowners secure the right mortgage solutions with confidence."
          primaryLabel="View All Graham County Areas"
          primaryHref="#areas"

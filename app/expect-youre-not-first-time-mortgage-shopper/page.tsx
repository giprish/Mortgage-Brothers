...
export const metadata: Metadata = getSeoMetadata("/expect-youre-not-first-time-mortgage-shopper/");
...
const articleJsonLd = buildArticleSchemas({
  blog: {
    ...
    headline: "What to Expect When You're Not a First Time Mortgage Shopper",
  ...
  breadcrumbs: [
    ...
    { name: "What to Expect When You're Not a First Time Mortgage Shopper", path: "/expect-youre-not-first-time-mortgage-shopper/" },
  ],
});
    ...
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow relative z-0">
        <ArticleHero
          ...
          excerpt="What experienced Phoenix homebuyers need to know about online lenders, choosing a broker, pre-approval, rate locks, and closing."

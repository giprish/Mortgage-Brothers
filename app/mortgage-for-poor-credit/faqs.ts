...
export const faqs = [
  ...
  { q: "What's the minimum credit score required for a mortgage?", a: "FHA loans: as low as 580 (with 3.5% down). USDA: most lenders look for at least 640 for automated approval, though scores as low as 620 may qualify with manual underwriting. VA: no official minimum. Conventional loans: typically 620 or higher." },
  ...
  { q: "How can I improve my chances of getting approved?", a: "Reduce your debt-to-income (DTI) ratio by paying off outstanding debts, save for a larger down payment, get a co-signer with strong credit, and work with a lender that specializes in low-credit mortgages." },

...
export const metadata: Metadata = getSeoMetadata("/arizona-second-mortgages/");
    ...
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow relative z-0">
        <ArticleHero
          ...
          excerpt="Understand Arizona second mortgages, home equity loans, HELOCs, and how homeowners can qualify to access equity."
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-10 lg:gap-14">
            <article className="min-w-0">
              ...
              <p className="text-[#3a4a3a] text-[16px] leading-[1.8] mb-6">
                Second Arizona mortgages are secured by the same property as a first lien Arizona mortgage.
                The first lien has priority. The first lien gets paid first if you default. The second lien
                gets paid whatever amount is left over. If there are no funds left after paying the first
                off, then the second won&apos;t get paid anything. Second mortgages are normally determined by
              ...
              <div className="mb-12 bg-white border border-[#e8e0d0]/70 rounded-2xl p-7 lg:p-8 text-center shadow-sm">
                ...
                <p className="text-[#4e5b4e] text-[15px] leading-relaxed mb-6 max-w-xl mx-auto">
                  A second mortgage can provide cash for renovations, debt consolidation, or investments. Find
                  out if it&apos;s the right move for you.
                </p>
              ...
              <div className="space-y-10 text-[#3a4a3a] text-[16px] leading-[1.8]">
                <section>
                  ...
                  <p className="mb-4">Second mortgages include:</p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Home Equity.</strong> A lump sum loan at a fixed rate.
                    </li>
                    <li>
                      <strong>Home equity line of credit (HELOC).</strong> Allows you to access cash when you
                      need it at a variable interest rate.
                    </li>
                    <li>
                      <strong>Traditional second mortgage</strong>
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p className="mb-5">
                    It is a good idea to work with an Arizona mortgage broker who can help you find the right
                    second mortgage product with favorable loan terms and the best interest rate. The mortgage
                    broker works with many lenders so they can offer you a variety of loan products to compare
                  ...
                  <p>
                    Second mortgages come in handy when you need extra cash, but you should have a plan to pay
                    the money back so you don&apos;t put yourself in debt and jeopardize losing your home.
                  </p>
                </section>

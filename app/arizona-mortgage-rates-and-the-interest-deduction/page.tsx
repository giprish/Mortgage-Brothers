...
export const metadata: Metadata = getSeoMetadata("/arizona-mortgage-rates-and-the-interest-deduction/");
    ...
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow relative z-0">
        <ArticleHero
          ...
          excerpt="Understand the mortgage interest tax deduction, why few homeowners claim it, and how demographics affect usage across states including Arizona."

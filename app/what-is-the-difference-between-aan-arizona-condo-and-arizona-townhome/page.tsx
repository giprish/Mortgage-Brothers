      ...
      <main className="flex-grow relative z-0">
        <section className="relative z-0 w-full bg-white overflow-hidden">
          <div className="w-[90%] max-w-[1520px] mx-auto px-0 py-3 lg:py-5">
            ...
            <img
              src="/home/what-is-the-difference-between-a-condo-and-a-townhome.jpg"
              alt="Comparison of the differences between a condo and a townhome, including ownership and costs."
              width={1920}
              height={1080}

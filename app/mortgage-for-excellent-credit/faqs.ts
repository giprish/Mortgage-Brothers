...
export const faqs = [
  ...
  { q: "Should I put more than the minimum down payment if I have excellent credit?", a: "While some programs allow **as little as 3% down**, a **larger down payment** (10-20%) can help you: Secure an **even lower interest rate**; Avoid **private mortgage insurance (PMI)**; Reduce your **monthly payment** and total loan cost." },
  { q: "Does checking mortgage rates impact my credit score?", a: "If you **apply for pre-approval**, lenders perform a **hard inquiry**, which may cause a small temporary dip in your credit score. However, checking rates through a **soft inquiry tool** (like our quote tool) does **not** affect your credit." },
  { q: "Can I refinance my mortgage if I already have excellent credit?", a: "Yes! Refinancing allows you to **lower your rate, shorten your loan term, or cash out equity**. Even with excellent credit, it's important to compare **current rates** and potential savings before refinancing. Every mortgage situation is unique. **Contact us today** for expert guidance on securing the best loan for your financial goals." },
];

      ...
      <main className="flex-grow relative z-0">
        <section className="relative z-0 w-full bg-white overflow-hidden">
          <div className="w-[90%] max-w-[1520px] mx-auto px-0 py-3 lg:py-5">
            ...
            <img
              src="/home/will-commissions-count-towards-a-loan.jpg"
              alt="Explanation of how commissions are considered for mortgage loans."
              width={1920}
              height={1080}
                  ...
                  <div className="space-y-8 text-[15.5px]">
                    <div>
                      ...
                      <ul className="list-disc pl-6 space-y-2 mb-3">
                        <li>Can I use this income to qualify for a mortgage?</li>
                        <li>How long do I need to show this income?</li>
                        <li>What are the rules for different loan types?</li>
                      </ul>

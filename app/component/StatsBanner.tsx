      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10">
        ...
        >
          {stats.map((stat, i) => (
            <div
              key={stat.label + i}
              className="flex flex-col items-center justify-center text-center px-2 py-2 sm:py-3 w-full min-w-0 max-w-[240px] sm:max-w-none mx-auto"
            >
              <div className="text-[#3fb364] text-[32px] sm:text-[38px] lg:text-[44px] font-bold leading-none mb-2.5 tracking-tight text-center w-full">
                {stat.value}
              </div>
              <div className="text-[#c8c8b8] text-[11px] sm:text-[12px] lg:text-[13.5px] font-medium uppercase tracking-wide sm:tracking-wider leading-snug text-center break-words hyphens-auto">
                {stat.label}
              </div>
            </div>
          ))}

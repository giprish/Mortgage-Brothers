...
const CreditQuizCta = ({
  ...
  title = "Is Your Credit Score Ready for Homeownership?",
  description =
    "Your credit score is the gateway to mortgage approval and better rates. Discover where you stand and how it impacts your home buying journey.",
}: CreditQuizCtaProps = {}) => {
  return (

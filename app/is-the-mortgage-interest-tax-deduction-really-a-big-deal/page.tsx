      ...
      <main className="flex-grow relative z-0">
        <section className="relative z-0 w-full bg-white overflow-hidden">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-4 lg:py-6">
            ...
            <img
              src="/home/is-the-mortgage-interest-tax-deduction-really-a-big-deal.jpg"
              alt="An analysis of how the mortgage interest deduction shapes financial strategies for homeowners."
              width={1920}
              height={1080}

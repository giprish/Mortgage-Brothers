      ...
      <main className="flex-grow relative z-0">
        <section className="relative z-0 w-full bg-white overflow-hidden">
          <div className="w-[90%] max-w-[1520px] mx-auto px-0 py-3 lg:py-5">
            ...
            <img
              src="/home/what-is-a-jumbo-loan-everything-you-need-to-know-before-applying.jpg"
              alt="What is a jumbo loan? Everything you need to know before applying in Arizona"
              width={1920}
              height={1080}

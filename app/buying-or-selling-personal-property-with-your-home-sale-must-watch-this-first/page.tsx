      ...
      <main className="flex-grow relative z-0">
        <section className="relative z-0 w-full bg-white overflow-hidden">
          <div className="w-[90%] max-w-[1520px] mx-auto px-0 py-3 lg:py-5">
            ...
            <img
              src="/home/buying-or-selling-personal-property-with-your-home-sale.jpg"
              alt="The impact of buying or selling personal property in a home sale on taxes and appraisals."
              width={1920}
              height={1080}

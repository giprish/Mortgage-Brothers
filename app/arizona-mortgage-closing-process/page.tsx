...
export const metadata: Metadata = getSeoMetadata("/arizona-mortgage-closing-process/");
    ...
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow relative z-0">
        <ArticleHero
          ...
          excerpt="Understand prior-to-closing conditions, what to bring on signing day, and how closing timing affects your Arizona mortgage."

...
export const metadata: Metadata = getSeoMetadata("/arizona-vacation-and-investment-home-mortgages/");
    ...
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow relative z-0">
        <ArticleHero
          ...
          excerpt="Learn down payment rules for Arizona vacation and investment homes, and why working with a local mortgage broker helps."

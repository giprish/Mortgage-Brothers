...
const jobBlocks = [
  {
    ...
    text: "Currently our team does not any Reverse Mortgage loan officer handling our reverse mortgage leads. We are interesting in hiring a reverse mortgage specialist who can take our leads and close the loans.",
  },
  {
    ...
    <div className="flex flex-col min-h-screen bg-[#fcf9f3]">
      ...
      <main className="flex-grow">
        <section
          ...
          style={{
            backgroundImage:
              "linear-gradient(90deg, rgb(52, 69, 37) 0%, rgb(50, 94, 63) 20%, rgba(255, 255, 255, 0) 100%), url('/home/reverse-mortgage-loan-officer.jpg')",
        ...
        <section id="Get-in-Touch" className="w-full bg-[#f5f0e8] py-16 lg:py-20 border-y border-[#e8e0d0]/50 scroll-mt-[90px]">
          <div className="max-w-4xl mx-auto px-6 lg:px-10">
            ...
            <div className="relative bg-white rounded-2xl shadow-sm overflow-hidden">
              ...
              <iframe
                src={JOB_FORM_SRC}
                title="Reverse Mortgage Loan Officer Application"

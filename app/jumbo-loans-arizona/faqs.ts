...
export const faqs = [
  { q: "What is a Jumbo Loan?", a: "A Jumbo Loan is a type of mortgage that exceeds the conventional loan limit set by Fannie Mae and Freddie Mac, which is currently $765,500. Because these loans are not eligible for purchase by these government-sponsored enterprises, they come with different requirements and higher risks for lenders." },
  ...
  { q: "How long does the approval process take for a Jumbo Loan?", a: "The approval process for a Jumbo Loan can vary but typically takes longer than conventional loans due to the additional documentation and scrutiny involved. It's advisable to allow several weeks for processing and approval. If you have more questions or need personalized assistance with your Jumbo Loan application, feel free to reach out to our team at AZ Mortgage Brothers! Get Your Jumbo Loan Quote Now" },
];

          ...
          <div className="max-w-5xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
              {whoQualifies.map((item, idx) => (
                <div
                  key={item.title}
                  className="group bg-white border border-[#e0e0e0] hover:border-[#3fb364] rounded-2xl p-6 shadow-sm transition-all"
                >
          ...
          <div className="max-w-5xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
              {loanTypes.map((item, idx) => (
                <div key={item.title} className="group bg-white border border-[#e0e0e0] hover:border-[#3fb364] rounded-2xl p-6 shadow-sm transition-all">
                  <div className={cardIconBadgeClassName("sm", "font-bold mb-4")}>
                    {idx + 1}
                  </div>
                  <h3 className="text-[17px] font-bold text-[#052316] mb-2 font-playfair">{item.title}</h3>

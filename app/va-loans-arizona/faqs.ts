...
export const faqs = [
  ...
  { q: "What credit score do I need for a VA loan?", a: "While the VA doesn't set a minimum credit score, most lenders require a score of at least 620. VA loans often offer competitive rates regardless of credit score. These answers provide general guidance. Contact our team for personalized information based on your specific situation." },
];

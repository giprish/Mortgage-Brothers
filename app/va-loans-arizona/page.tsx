...
export default function VaLoansArizonaPage() {
  ...
  const faqs = [
    {
      q: "Can I use my VA loan benefits multiple times?",
      a: "Yes, even if you currently have a VA loan, you may be eligible for another VA loan with 0% down. Eligibility depends on your remaining entitlement and the county where you plan to purchase."
    },
    {
      q: "What types of properties can I buy with a VA loan?",
      a: "VA loans can be used for existing homes, new construction, approved condominiums, and owner-occupied multi-family properties up to 4 units."
    },
    {
      q: "Can I refinance my current mortgage with a VA loan?",
      a: "Yes, you can refinance both VA and non-VA loans using either an Interest Rate Reduction Refinance Loan (IRRRL) or a VA cash-out refinance."
    },
    {
      q: "Can I use my VA loan for high-end properties?",
      a: "Yes, VA jumbo loans are available for loan amounts up to $2,000,000 for borrowers with sufficient entitlement. Veterans with full entitlement have no VA loan limit -- a down payment is only required if your entitlement has been reduced by a previous VA loan."
    },
    {
      q: "Can I take cash out with a VA loan?",
      a: "Yes, qualified veterans can access up to 100% of their home's value through a VA cash-out refinance for home improvements, debt consolidation, or other needs."
    },
    {
      q: "What credit score do I need for a VA loan?",
      a: "While the VA doesn't set a minimum credit score, most lenders require a score of at least 620. VA loans often offer competitive rates regardless of credit score."
    }
  ];
  ...
  const costs = [
    {
      ...
      desc: "A one-time charge ranging from 1.4% to 3.6% of the loan amount, which can be financed into the loan."
    },
    {
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5 space-y-5 text-left">
              ...
              <h2 className="text-[#052316] text-[28px] lg:text-[36px] font-bold font-playfair leading-tight">
                Why Choose AZ Mortgage Brothers for Your VA Loan?
              </h2>
              <p className="text-[#4e5b4e] text-[15.5px] leading-relaxed">
        ...
        <section className="py-16 lg:py-20 px-6 lg:px-12 bg-[#052316] text-white">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-[#c8c8b8] text-[16px] max-w-2xl mx-auto leading-relaxed">
              Our team is ready to help. Contact AZ Mortgage Brothers for personalized VA loan guidance.
            </p>
